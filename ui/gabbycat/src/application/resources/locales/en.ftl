...
account-muted = Muted
account-posts = Gabs
account-posts_with_replies = Gabs and replies
...
compose_form-direct_message_warning = This gab will only be sent to the mentioned users.
compose_form-direct_message_warning_learn_more = Learn more
compose_form-hashtag_warning = This gab won't be listed under any hashtag as it is unlisted. Only public gabs can be searched by hashtag.
...
empty_column-account_timeline = No gabs here!
empty_column-account_unavailable = Profile unavailable
empty_column-blocks = You haven't blocked any users yet.
empty_column-community = The local timeline is empty. Write something publicly to get the ball rolling!
empty_column-direct = You don't have any direct messages yet. When you send or receive one, it will show up here.
empty_column-domain_blocks = There are no hidden domains yet.
empty_column-favourited_statuses = You don't have any favorite gabs yet. When you favorite one, it will show up here.
empty_column-favourites = No one has favorited this gab yet. When someone does, they will show up here.
...
getting_started-open_source_notice = Gabbycat is open source software. You can contribute or report issues on our GitHub repository.
...
keyboard_shortcuts-pinned = to open pinned gabs list
...
keyboard_shortcuts-toot = to start a new gab
...
navigation_bar-pins = Pinned gabs
